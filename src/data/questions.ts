import { QuizQuestion } from "@/types/mbti";

export const questions: QuizQuestion[] = [
  {
    id: 1,
    dimension: "EI",
    dimensionLabel: "에너지의 방향",
    question:
  ...
  },
  {
    ...
    dimensionLabel: "에너지의 방향",
    question:
      "대면 미팅과 슬랙(Slack)/카카오톡 업무 메세지 중 내가 더 선호하는 소통 방식은?",
    options: [
      {
        id: "A",
        text: "말로 빠르게 치고받으며 회의실에서 화이트보드에 적으며 얘기하는 게 편하다.",
        letter: "E",
      },
      {
        id: "B",
        text: "생각과 텍스트를 정리해서 비동기식 메세지로 소통하는 게 훨씬 편하다.",
        letter: "I",
      },
    ],
  },
  ...
  },
  {
    ...
    dimensionLabel: "정보 인식의 방식",
    question:
      "선배가 \"요즘 인공지능(AI) 트렌드가 급변하고 있네요\"라고 말했을 때 내 머릿속 떠오르는 생각은?",
    options: [
      {
        id: "A",
